...
def evaluate(epoch_predicts, epoch_labels, vocab, threshold=0.5, top_k=None):
    ...
    # epoch_gold_label contains labels instead of ids
    ...
    for sample_predict, sample_gold in zip(epoch_predicts, epoch_gold):
        ...
        #print(np.array(sample_predict_id_list))
        #print(np.array(sample_gold))
    ...
    #print("Preditions",total_predict_label_list)
    #print("Ground Truth",epoch_gold_label)
    ...
    print("Samples-F1:",f1_score(y_true, y_pred, average='samples'))
